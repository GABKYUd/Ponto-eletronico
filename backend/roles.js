...
const PERMISSIONS = {
    ...
    [ROLES.HR]: ['MANAGE_INVITES', 'REVOKE_SESSION', 'VIEW_ALL_RECEIPTS', 'MANAGE_USERS', 'VIEW_PROFILES', 'SEND_GLOBAL_MAIL'],
    [ROLES.HRAssistant]: ['VIEW_ALL_RECEIPTS', 'VIEW_PROFILES', 'SEND_GLOBAL_MAIL', 'VERIFY_RECEIPT_CODES'],
